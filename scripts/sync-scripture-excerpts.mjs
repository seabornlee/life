...
const references = [
  ...
  { reference: '马太福音 6:9-13', book: 40, chapter: 6, start: 9, end: 13 },
  { reference: '诗篇 13', book: 19, chapter: 13, start: 1, end: 6 },
  { reference: '诗篇 22', book: 19, chapter: 22, start: 1, end: 31 },
  { reference: '诗篇 88', book: 19, chapter: 88, start: 1, end: 18 },
